...
const LandingPage = () => {
    ...
    const handleLoginClick2 = () => {
        navigate('/registration_customer'); // Navigate to the register page
    };
    ...
    useEffect(() => {
        if (videoRef.current) {
            videoRef.current.playbackRate = 1.25; // Set playback speed to 2x
        }
    ...
    return (
        <div>
            ...
            <div className="landing-video">
                <div className="landingimagebgcolor"></div>
            ...
            <h1 className="effect1"> Welcome to AutoGarage </h1>
            <p className="text" style={{ textAlign: 'center', fontSize: '1.5em',paddingLeft: '700px'}} onClick={handleLoginClick}>Login as Owner</p>
        </div>
            <p className="text"  style={{ textAlign: 'center', fontSize: '1.5em',paddingLeft: '150px' }}onClick={handleLoginClick2}>Login as Customer</p>
